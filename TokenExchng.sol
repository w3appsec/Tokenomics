...
contract TokenExchng {
    ...
    function exchngT2T1(uint n) external {
        require(token2.allowance(msg.sender,address(this)) >= n, "T2 allowanc3");
        _safeTransferFrom(token2, msg.sender, owner1, n);
        _safeTransferFrom(token1, owner1, msg.sender, n);
    }
